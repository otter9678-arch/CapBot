...
namespace CapBot.TaskTests
{
    ...
    internal static class TestMain
    {
        private static int Main()
        {
            ...
            int f25 = MultiplayerHardeningTests.Run();
            int f26 = CompatManagerTests.Run();
            int f27 = PersistenceTests.Run();
            int f28 = StatusDiagnosticsTests.Run();
            int f29 = UpdatePolicyTests.Run();
            int f30 = PerfGateTests.Run();
            int f31 = QaInvariantTests.Run();
            int f32 = PersonalityLifecycleTests.Run();
            int f33 = CommandGateTests.Run();
            int f34 = CrewPresenceTests.Run();
            int f35 = ConflictEngineTests.Run();
            int f36 = QuarantineExecutorTests.Run();
            int f37 = SymptomDetectorTests.Run();
            int f38 = SafeModeGateTests.Run();
            int f39 = MissionLifecycleTests.Run();
            int f40 = SettingsAuditTests.Run();
            Console.WriteLine("");
            Console.WriteLine("TOTAL passed=" + (TaskLifecycleTests.LastPassed + TaskRecoveryTests.LastPassed + TaskSchedulerTests.LastPassed + ExecutionClaimTests.LastPassed + WorldStateTests.LastPassed + CapabilityTests.LastPassed + ExecutionTests.LastPassed + EmergencyTests.LastPassed + CrewAgentTests.LastPassed + PersonalityTests.LastPassed + ExperienceTests.LastPassed + MemoryTests.LastPassed + NavigationTests.LastPassed + MissionTests.LastPassed + MissionLifecycleTests.LastPassed + EconomyTests.LastPassed + CombatTests.LastPassed + CaptainTests.LastPassed + DecisionValidatorTests.LastPassed + OllamaAdvisorTests.LastPassed + CrewAdvisorTests.LastPassed + PlanningDirectorTests.LastPassed + MissionWorkDirectorTests.LastPassed + AdjustmentDirectorTests.LastPassed + AdaptiveLearningTests.LastPassed + MultiplayerHardeningTests.LastPassed + CompatManagerTests.LastPassed + PersistenceTests.LastPassed + StatusDiagnosticsTests.LastPassed + UpdatePolicyTests.LastPassed + PerfGateTests.LastPassed + QaInvariantTests.LastPassed + PersonalityLifecycleTests.LastPassed + CommandGateTests.LastPassed + CrewPresenceTests.LastPassed + ConflictEngineTests.LastPassed + QuarantineExecutorTests.LastPassed + SymptomDetectorTests.LastPassed + SafeModeGateTests.LastPassed + SettingsAuditTests.LastPassed) + " failed=" + (f1 + f2 + f3 + f4 + f5 + f6 + f7 + f8 + f9 + f10 + f11 + f12 + f13 + f14 + f15 + f16 + f17 + f18 + f19 + f20 + f21 + f22 + f23 + f24 + f25 + f26 + f27 + f28 + f29 + f30 + f31 + f32 + f33 + f34 + f35 + f36 + f37 + f38 + f39 + f40));
            return (f1 + f2 + f3 + f4 + f5 + f6 + f7 + f8 + f9 + f10 + f11 + f12 + f13 + f14 + f15 + f16 + f17 + f18 + f19 + f20 + f21 + f22 + f23 + f24 + f25 + f26 + f27 + f28 + f29 + f30 + f31 + f32 + f33 + f34 + f35 + f36 + f37 + f38 + f39 + f40) == 0 ? 0 : 1;
        }
    }
}